...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LALT,  KC_LCMD, KC_SPACE, KC_FN, KC_ENTER, KC_RCMD, KC_RALT
  ),
  [_FN] = LAYOUT(
    KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_INSERT, KC_DELETE,
    KC_TAB, _______, _______, _______, _______, _______, _______, _______, KC_UP, KC_SCROLLLOCK, KC_PAUSE, _______, KC_RBRACKET, KC_BSPACE,
    KC_LCTRL, _______, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RIGHT, KC_SCOLON, KC_QUOTE, KC_ENTER,
    KC_LSHIFT, _______, _______, _______, _______, _______, _______, _______, KC_END, KC_PGDOWN,  _______, KC_RSHIFT, KC_FN,
    KC_LALT, KC_LCMD, KC_SPACE, KC_FN, KC_SPACE, KC_RCMD, KC_RALT
  )
};
